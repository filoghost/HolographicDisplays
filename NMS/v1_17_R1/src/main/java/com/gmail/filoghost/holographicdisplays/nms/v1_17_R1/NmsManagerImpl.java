...
public class NmsManagerImpl implements NMSManager {
    ...
    public void registerCustomEntity(Class<? extends Entity> entityClass, int id, float sizeWidth, float sizeHeight) throws Exception {
        ...
        Map<EntityTypes<?>, Integer> entityTypesToId = REGISTRY_TO_ID_FIELD.get(IRegistry.Y);
        EntityTypes<?> customEntityTypes = EntityTypes.Builder.a(EnumCreatureType.a).a(sizeWidth, sizeHeight).b().a((String) null);

...
public class EntityNMSArmorStand extends EntityArmorStand implements NMSArmorStand {
    ...
    public EntityNMSArmorStand(World world, HologramLine parentPiece) {
        ...
        this.setOnGround(true); // Workaround to force EntityTrackerEntry to send a teleport packet.
    }
    ...
    public CraftEntity getBukkitEntity() {
        if (customBukkitEntity == null) {
            customBukkitEntity = new CraftNMSArmorStand(super.getWorld().getServer(), this);
        }
    ...
    private void broadcastLocationPacketNMS() {
        ...
        for (Object obj : super.getWorld().getPlayers()) {
            if (obj instanceof EntityPlayer) {
                ...
                if (distanceSquared < 8192 && nmsPlayer.b != null) {

...
class DataWatcherKey<T> {
    ...
    static final DataWatcherKey<Optional<ItemStack>> ITEM_STACK = new DataWatcherKey<>(5, ITEM_STACK_SERIALIZER);
    static final DataWatcherKey<Byte> ARMOR_STAND_STATUS = new DataWatcherKey<>(10, BYTE_SERIALIZER);
    static final DataWatcherKey<Integer> SLIME_SIZE = new DataWatcherKey<>(11, INT_SERIALIZER);
